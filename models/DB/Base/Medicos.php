...
/**
 * Base class that represents a row from the 'medicos' table.
 *
 *
 *
 * @package    propel.generator.DB.Base
 */
abstract class Medicos implements ActiveRecordInterface
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\DB\\Map\\MedicosTableMap';
    ...
    /**
     * Compares this with another <code>Medicos</code> instance.  If
     * <code>obj</code> is an instance of <code>Medicos</code>, delegates to
     * <code>equals(Medicos)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[MedicosTableMap::COL_ID] = true;
        }
    ...
    public function setNombre($v)
    {
        ...
        if ($this->nombre !== $v) {
            $this->nombre = $v;
            $this->modifiedColumns[MedicosTableMap::COL_NOMBRE] = true;
        }
    ...
    public function setEspecialidad($v)
    {
        ...
        if ($this->especialidad !== $v) {
            $this->especialidad = $v;
            $this->modifiedColumns[MedicosTableMap::COL_ESPECIALIDAD] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : MedicosTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : MedicosTableMap::translateFieldName('Nombre', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload(bool $deep = false, ?ConnectionInterface $con = null): void
    {
        ...
        $dataFetcher = ChildMedicosQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws \Propel\Runtime\Exception\PropelException
     * @see Medicos::setDeleted()
     * @see Medicos::isDeleted()
     */
    public function delete(?ConnectionInterface $con = null): void
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildMedicosQuery::create()
    ...
    public function save(?ConnectionInterface $con = null): int
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MedicosTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(MedicosTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(MedicosTableMap::COL_NOMBRE)) {
    ...
    {
        $pos = MedicosTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Medicos'][$this->hashCode()])) {
            return ['*RECURSION*'];
        }
        $alreadyDumpedObjects['Medicos'][$this->hashCode()] = true;
        $keys = MedicosTableMap::getFieldNames($keyType);
        $result = [
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(MedicosTableMap::COL_ID)) {
            $criteria->add(MedicosTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(MedicosTableMap::COL_NOMBRE)) {
            $criteria->add(MedicosTableMap::COL_NOMBRE, $this->nombre);
        }
        if ($this->isColumnModified(MedicosTableMap::COL_ESPECIALIDAD)) {
    ...
    {
        $criteria = ChildMedicosQuery::create();
        $criteria->add(MedicosTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of \DB\Medicos (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \DB\Medicos Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * If this ChildMedicos is new, it will return
     ...
     * Otherwise if this Medicos is new, it will return
     * an empty collection; or if this Medicos has previously
     * been saved, it will retrieve related Citass from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Medicos.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param ConnectionInterface $con optional connection object
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildCitas}> List of ChildCitas objects
     */
    public function getCitassJoinPacientes(?Criteria $criteria = null, ?ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCitasQuery::create(null, $criteria);
        $query->joinWith('Pacientes', $joinBehavior);
    ...
    {
        return (string) $this->exportTo(MedicosTableMap::DEFAULT_STRING_FORMAT);
    }
